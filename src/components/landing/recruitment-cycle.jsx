  ...
  return (
    <div className="w-full relative">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(0, 0, 139, 0.6) 0%, rgba(0, 0, 80, 0.4) 50%, transparent 100%)",
        }}
      />
                      ...
                      <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center border-2 border-blue-400/50 shadow-lg">
                        <div className="w-6 h-6 rounded-full bg-blue-400 flex items-center justify-center">
                          ...
                          >
                            ...
                            {step.id === 2 && (
                              <path d="M16 4c0-1.11.89-2 2-2s2 .89 2 2c0 .88-.59 1.64-1.41 1.86C18.85 6.58 19 7.27 19 8v3l-3 4v2h-2v-2l-3-4V8c0-.73.15-1.42.41-2.14C10.59 5.64 10 4.88 10 4c0-1.11.89-2 2-2s2 .89 2 2z" />
                            )}
                            {step.id === 3 && (
